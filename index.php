				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-6 col-md-6 ">
							<h6 class="text-white mt-2">Need a shipment? just call</h6>
							<h1 class="text-uppercase">
							 2348143200267				
							</h1>
							<p class="pt-10 pb-10 text-white">
								Whether you enjoy city lines or extended walks in the open, you can always improve your shipping experience by staying in a safer look through speedcourier.
							</p>
							<a href="#" class="primary-btn text-uppercase" style="border-radius:10px;"> Call  for a shipment </a>
						</div>
						<div class="col-lg-4  col-md-6 header-right">
							<h4 class="pb-30">Book Your Shipment Online!</h4>
							<form class="form" method="post" id="distance_form">
								...
								<div class="form-group">
									...
									<div class="input-group-prepend">
										<span class="input-group-text foot-link"><span class="fa fa-map-marker"></span></span>
									</div>		
									</div>				    	
								</div>	
								...
								<div class="form-group">
									<div class="input-group">
							    	<input id="to" class="form-control" type="text" name="to_place" placeholder="Target Destination"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Target Destination'" required >	 
